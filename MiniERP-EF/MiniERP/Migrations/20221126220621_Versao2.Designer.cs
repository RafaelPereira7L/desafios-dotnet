...
namespace MiniERP.Migrations
{
    ...
    [Migration("20221126220621_Versao2")]
            ...
            modelBuilder.Entity("MiniERP.Models.Nota", b =>
                {
                    ...
                    b.HasOne("MiniERP.Models.Produto", "Total")
                        .WithMany()
                        .HasForeignKey("TotalIdProduto");
                });
